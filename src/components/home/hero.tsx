...
function HeroCards(): React.ReactNode {
  ...
  return (
    <div className={"justify-self-end flex-[1] flex items-end max-lg:flex-wrap max-lg:justify-around max-lg:gap-6 max-lg:hidden"}>
      <div
        className={
          defaultStyle +
          " " +
...
function HeroInfo(): React.ReactNode {
  return (
    <div className="flex flex-col gap-[1.5em] max-lg:gap-4 items-center flex-[1] justify-center max-lg:min-h-[calc(100vh_-_(var(--nav-height)_+_40px))] max-w-[var(--max-width)]">
