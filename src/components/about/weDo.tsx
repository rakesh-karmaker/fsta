...
export default function WeDo(): React.ReactNode {
  return (
    <section className="w-full flex gap-14 justify-between max-w-mx self-center [padding-top:9em!important] [padding-bottom:9em!important]">
      ...
      <p className="text-black-80 text-xl flex flex-col gap-6 max-w-[73ch]">
        <span>
